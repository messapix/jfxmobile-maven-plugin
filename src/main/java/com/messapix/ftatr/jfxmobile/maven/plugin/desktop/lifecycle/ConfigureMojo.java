...
import com.messapix.ftatr.jfxmobile.maven.plugin.desktop.AbstractDesktopMojo;
 ...
 * @author Alfio Gloria
 */
@Mojo( name = "desktop-configure" )
public class ConfigureMojo extends AbstractDesktopMojo {
    @Component
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        // Create target dirs
        for ( Target target : DesktopTarget.values() ) {
