 ...
 * @author Alfio Gloria
 */
@Mojo( name = "android-package-main" )
public class MainPackageMojo extends AbstractMojo {
    @Component
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ant.jar( fs.path( MainTarget.RETROLAMBDADIR ), fs.path( MainTarget.RETROLAMBDAJAR ) );
    }
}
