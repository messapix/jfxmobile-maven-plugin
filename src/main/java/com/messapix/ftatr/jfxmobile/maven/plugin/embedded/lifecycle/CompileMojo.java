 ...
 * @author Alfio Gloria
 */
@Mojo( name = "embedded-compile", requiresDependencyResolution = ResolutionScope.COMPILE )
public class CompileMojo extends AbstractCompilerMojo {
    ...
    protected List<String> getCompileSourceRoots() {
        return Arrays.asList( fs.string( EmbeddedSource.SOURCEDIR ) );
    }

    @Override
    protected File getOutputDirectory() {
        return fs.file( EmbeddedTarget.CLASSESDIR );
    }
