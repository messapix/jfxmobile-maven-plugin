 ...
 * @author Alfio Gloria
 */
@Mojo( name = "desktop-compile", requiresDependencyResolution = ResolutionScope.COMPILE )
public class CompileMojo extends AbstractCompilerMojo {
    ...
    protected List<String> getCompileSourceRoots() {
        return Arrays.asList( fs.string( DesktopSource.SOURCEDIR ) );
    }

    @Override
    protected File getOutputDirectory() {
        return fs.file( DesktopTarget.CLASSESDIR );
    }
